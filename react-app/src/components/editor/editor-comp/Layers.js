...
const Layers = ({layerTable, pageNumber, lessMoreTable, rmPhotoClick, lessMoreClick, makeLayerUP, makeLayerDown, handleWidthSliderChange, xTable, originalPageWidth, handleXSliderChange, yTable, originalPageHeight, handleYSliderChange, alignWidth, getLayerTitle, editText, fonts, handleColorPickerVisibility, textColor, showLayerPicker, ChromePicker, setSingleColorText, rotateTable, setRotateTable, borderTable, setBorderTable, shadowTable, setShadowTable}) => {
  ...
  return (
    <div style={{display: 'flex', justifyContent: 'center'}}>
              <div style={{width: '95%', borderRadius: '15px', overflow: 'hidden'}}>
              <div style={{flex: '1', minHeight: '500px', maxHeight: '500px', width: '100%', overflowY: 'scroll', marginLeft: 'auto', marginRight: 'auto', backgroundColor: 'rgba(255, 255, 255, 0.5)', borderRadius: '15px', border: '2px solid white'}}>
              {layerTable[pageNumber].map((item, index) => (
                item.startsWith("http")?(
                
                <div style={{marginTop: '5px', marginLeft: '5px', display: 'flex', flexDirection: 'column', width: '96%', border: '2px solid white', borderRadius: '15px', backgroundColor: 'rgba(255, 255, 255, 0.5)'}}>
                  ...
                  <div style={{display: 'flex', justifyContent: 'center', width: '100%'}}>
                    <div style={{marginTop: '5px', display: 'flex', flexDirection: 'column', width: '96%', border: '2px solid white', borderRadius: '15px', backgroundColor: 'rgba(255, 255, 255, 0.5)'}}>
